...
app.get('/categories', authenticateToken, checkRole(['KLIENT', "PRACOWNIK"]),   db.getCategories);
app.get('/products', authenticateToken, checkRole(['KLIENT', 'PRACOWNIK']), db.getProducts);
app.get('/products/:id', authenticateToken, checkRole(['KLIENT', 'PRACOWNIK']),  db.getProductById);
...
app.get('/orders', authenticateToken, checkRole(['KLIENT', 'PRACOWNIK']), db.getOrders);
app.post('/orders', authenticateToken, checkRole(['KLIENT']), db.createOrder);
app.get('/orders/status/:id', authenticateToken, checkRole(['KLIENT', 'PRACOWNIK']), db.getOrdersStatus);
...
app.get('/order/:id/products', authenticateToken, checkRole(['PRACOWNIK']), db.showProductsInOrder)
